...
public class NoteActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cursor = getNoteDao().getDatabase().query(getNoteDao().getTablename(), getNoteDao().getAllColumns(), null, null, null, null, orderBy);
    ...
    private NoteDao getNoteDao() {
        ...
        return DbHelper.getInstance(this).getNoteDao();
    }
